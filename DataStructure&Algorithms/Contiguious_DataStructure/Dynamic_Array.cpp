...
template<typename T>
T& Dynamic_Array <T>::at(const int index) {	// std�Լ������� at()�� ������ �뵵 => ����ó���� ����
	if (index < data_size) return data_ptr[index];
	throw "Index out of range";							//main ���� �߻��� �� �ִ� ����ó�����
}
...
Dynamic_Array<T> operator+(const Dynamic_Array<T>& arr1,const Dynamic_Array<T>& arr2) {
	Dynamic_Array<T> Ret_Arr (arr1.size()+arr2.size());	//�����ǵ� operator +�� �ƴ� sizetype �� sum��
